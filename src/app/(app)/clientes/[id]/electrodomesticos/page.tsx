...
import { ClientAppliancesManager } from "@/features/clientes/client-appliances-manager"
import { Skeleton } from "@/components/ui/skeleton"
import { auth } from "@/features/auth"

export const dynamic = "force-dynamic"

interface ClientAppliancesPageProps {
  params: {
    id: string
  }
}

export default async function ClientAppliancesPage({ params }: ClientAppliancesPageProps) {
