...
export const statusOptions = [
  ...
  { label: "Presupuestado", value: "FACTURADO" }, // <-- AJUSTE AQUÍ
  { label: "Completada", value: "COMPLETED" },
  { label: "Finalizado", value: "DELIVERED" },
...
export const getStatusText = (status: string) => {
  switch (status) {
    ...
    case "FACTURADO":
      return "Presupuestado"; // <-- AJUSTE AQUÍ
    case "ENTREGA_GENERADA":
