...
interface OrderRowActionsProps {
  order: ServiceOrder;
  isReadOnly?: boolean; // Se añade la nueva propiedad
}

export function OrderRowActions({ order, isReadOnly = false }: OrderRowActionsProps) {
// --- FIN DE CAMBIOS ---
    ...
    <div className="relative" onClick={(e) => e.stopPropagation()}>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-[180px]">
          ...
          <DropdownMenuItem 
            // CAMBIO: La ruta ahora apunta a la vista del técnico
            onClick={() => window.open(`/tecnico/ordenes/${order.id}`, '_blank')}
          ...
          {/* --- INICIO DE CAMBIOS --- */}
          {/* Opciones que solo se muestran si NO es de solo lectura */}
          {!isReadOnly && (
            <>
              <DropdownMenuSeparator />
      ...
      {/* El diálogo de eliminación se mantiene, pero solo se activará si !isReadOnly */}
