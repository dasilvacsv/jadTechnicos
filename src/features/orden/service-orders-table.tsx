...
// Añade la nueva prop `isReadOnly`
interface ServiceOrdersTableProps {
  orders: any[];
  isReadOnly?: boolean; // <-- NUEVA PROP
}

export function ServiceOrdersTable({ orders: initialOrders, isReadOnly = false }: ServiceOrdersTableProps) {
      ...
      <Tabs defaultValue="all" value={activeTab} onValueChange={handleTabChange} className="w-full">
        ...
        <div className="flex flex-col space-y-3 mb-4">
          <div className="flex flex-col sm:flex-row justify-between gap-3">
            ...
            {/* GRUPO DE BOTONES DE ACCIÓN (condicional) */}
            {!isReadOnly && (
              <div className="flex items-center gap-2">
                ...
                <TableActions filteredRows={table.getFilteredRowModel().rows} />
              </div>
            )}
          </div>
        ...
        {isMobile ? (
          <MobileView
            ...
            isReadOnly={isReadOnly} // <-- Prop pasada
          />
        ) : (
          <DesktopView
            table={table}
