...
export function SucursalCard({ 
  ...
  const whatsappStatus = sucursal.whatsappInstanceStatus || "disconnected"
  const hasWhatsAppInstance = !!sucursal.whatsappInstanceName

  const getWhatsAppStatusIcon = () => {
    if (!hasWhatsAppInstance) return <MessageCircle className="h-4 w-4 text-gray-400" />
  ...
  const getWhatsAppStatusText = () => {
    if (!hasWhatsAppInstance) return "Sin WhatsApp"
    return whatsappStatus === "connected" ? "WhatsApp conectado" : "WhatsApp desconectado"
  }
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm">{getWhatsAppStatusText()}</span>
            </div>
          </div>
        </CardContent>
        ...
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              WhatsApp - {sucursal.name}
            </DialogTitle>
            <DialogDescription>
              Configura y gestiona la instancia de WhatsApp para esta sucursal
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4">
            <WhatsAppInstanceCard
              ...
              userId={userId}
              initialStatus={{
                hasInstance: hasWhatsAppInstance,
